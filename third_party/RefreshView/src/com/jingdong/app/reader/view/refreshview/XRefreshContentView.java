...
import com.jingdong.app.reader.view.refreshview.XScrollView.OnScrollBottomListener;
...
import com.jingdong.app.reader.view.refreshview.recyclerview.BaseRecyclerAdapter;
import com.jingdong.app.reader.view.refreshview.recyclerview.XSpanSizeLookup;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime,OnBottomLoadMoreTime {
    ...
    public boolean canChildPullDown() {
        if (child instanceof AbsListView) {
            ...
            return canScrollVertically(child, -1) || absListView.getChildCount() > 0
