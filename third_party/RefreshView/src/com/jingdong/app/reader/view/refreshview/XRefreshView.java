...
import com.jingdong.app.reader.view.refreshview.callback.IHeaderCallBack;
import com.jingdong.app.reader.view.refreshview.listener.OnBottomLoadMoreTime;
import com.jingdong.app.reader.view.refreshview.listener.OnTopRefreshTime;
import com.jingdong.app.reader.view.refreshview.utils.LogUtils;
import com.jingdong.app.reader.view.refreshview.utils.Utils;
...
public class XRefreshView extends LinearLayout {
    ...
    @Override
    protected void onLayout(boolean changed, int leftPos, int topPos, int rightsPos, int bottomPos) {
        super.onLayout(changed, leftPos, topPos, rightsPos, bottomPos);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != View.GONE) {
                if (i == 0) {
                    ...
                    child.layout(0/*left*/, top - mHeaderViewHeight/*top*/,child.getMeasuredWidth()/*right*/, top + adHeight/*bottom*/);
                    top += adHeight;
                } else if (i == 1) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                deltaY = currentY - mLastY;//垂直坐标差量
                deltaX = currentX - mLastX;//水平坐标差量
                mLastY = currentY;
                mLastX = currentX;
    ...
    private void updateHeaderHeight(int currentY, int deltaY, int... during) {
        ...
        if (isAutoRefresh) {
            mHeaderCallBack.onStateRefreshing();
            //滚动特定距离
            startScroll(deltaY/*滚动距离*/, during[0]/*滑动持续时间*/);
        } else {
