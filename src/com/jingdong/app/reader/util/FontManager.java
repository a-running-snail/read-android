        ...
        for ( String fontdir : fontdirs )
        {
            ...
            for ( File file : files )
            {
                ...
                if ( fontname != null ) {
                	...
                	if(filepath.contains("DroidSans.ttf") || filepath.contains("DroidSansFallback.ttf"))
                		fonts.put( file.getAbsolutePath(), fontname +"==="+ file.length() );
                }
            ...
            for ( int i = 0; i < numTables; i++ )
            {
                ...
                if ( tag == 0x6E616D65 )
                {
                    ...
                    for ( int record = 0; record < count; record++ )
                    {
                        ...
                        int platformSpecificID = getWord( table, nameid_offset + 2 );
                        int languageID = getWord( table, nameid_offset + 4 );
