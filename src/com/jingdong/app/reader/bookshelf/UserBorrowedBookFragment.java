...
public class UserBorrowedBookFragment extends CommonFragment implements
		RefreshAble {
	...
	private class BookListAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			String endtime = eBook.getUserBuyBorrowEndTime();
...
//			}
	...
	private void borrowBook(JDBookDetail onlineBookEntity) {
		...
		String userBuyBorrowEndTime = OlineDesUtils.encrypt(onlineBookEntity.getUserBuyBorrowEndTime());
		orderEntity.userBuyBorrowEndTime = userBuyBorrowEndTime;
		orderEntity.borrowEndTime = userBuyBorrowEndTime;
	...
	private void listBorrowedEbook() {
		...
		WebRequestHelper.post(URLText.JD_BASE_URL, RequestParamsPool
				.getUserBorrowedEbookParams(currentPage + "", perPageCount + ""),
				true,
	...
	public void refresh(DownloadedAble DownloadAble) {
		...
		if (localBook == null || bookListAdapter == null) {
			return;
		}
