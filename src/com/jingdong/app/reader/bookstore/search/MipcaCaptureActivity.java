...
public class MipcaCaptureActivity extends Activity implements Callback {
	...
	protected void onResume() {
		...
		initBeepSound();
		vibrate = true;
		StatService.onPageStart(this, MZBookApplication.getInstance().getString(R.string.mtj_bookstore_search_scan));
	}
	...
	protected void onPause() {
		...
		StatService.onPageEnd(this, MZBookApplication.getInstance().getString(R.string.mtj_bookstore_search_scan));
	}
