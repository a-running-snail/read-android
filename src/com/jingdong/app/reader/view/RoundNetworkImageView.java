...
/**
 * 书城圆圈View
 * 来源于开源：https://github.com/hdodenhof/CircleImageView
 *
 */
public class RoundNetworkImageView extends ImageView {
	...
	private static final int DEFAULT_BORDER_COLOR = Color.parseColor("#F7F7F7");
	...
	public RoundNetworkImageView(Context context, AttributeSet attrs,int defStyle) {
		...
		mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundNetworkImageView_border_width,DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.RoundNetworkImageView_border_color,DEFAULT_BORDER_COLOR);
		a.recycle();
		init();
	}
	...
	private void setup() {
		...
		//位图的渲染器
		mBitmapShader = new BitmapShader(mBitmap/*位图*/, Shader.TileMode.CLAMP/*边缘拉伸*/,Shader.TileMode.CLAMP/*边缘拉伸*/);
		mBitmapPaint.setAntiAlias(true);//抗锯齿
		mBitmapPaint.setShader(mBitmapShader);//渲染器
		mBorderPaint.setStyle(Paint.Style.STROKE);
		mBorderPaint.setColor(mBorderColor);//边框颜色
