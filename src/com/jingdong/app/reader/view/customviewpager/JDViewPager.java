package com.jingdong.app.reader.view.customviewpager;
...
public class JDViewPager extends ViewPager {
    ...
    public JDViewPager(Context paramContext) {
        super(paramContext);
        init();
    }

    public JDViewPager(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
            ...
            if ((currentItem == 0 && downX <= touchX) || (currentItem == pageCount - 1 && downX >= touchX)) {
                if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT) {
                    ...
                    if (pageCount > 1) {
                    	int item = pageCount - currentItem - 1;
                    	MZLog.d("JDViewPager", item+"");
