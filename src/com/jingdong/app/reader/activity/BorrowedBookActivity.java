...
//
//public class BorrowedBookActivity extends BaseActivityWithTopBar implements
//		RefreshAble {
//
...
//		super.onResume();
//		// listBorrowedEbook();
//		StatService.onPageStart(this, MZBookApplication.getInstance().getString(R.string.mtj_bookshelf_jieyue));
//	}
//	
//	@Override
//	protected void onPause() {
//		super.onPause();
//		StatService.onPageEnd(this, MZBookApplication.getInstance().getString(R.string.mtj_bookshelf_jieyue));
//	}
//
...
//					+ ",endtime=" + endtime);
//			int time = (int) (startDate - endDate);
//			if (time > 0) {
...
//				MZLog.d("cj", eBook.getName() + ", days==============>>" + days);
//				if (TimeFormat.DateCompare(endDate, startDate)) {
//					holder.borrow_lasttime.setText("借阅剩余" + days + "天");
//				} else {
//					long hour = 0;
//					;
//					if (endDate > startDate) {// 结束时间大于现在时间
//						hour = 24 - TimeFormat.getHour(starttime)
//								+ TimeFormat.getHour(endtime);
//						holder.borrow_lasttime.setText("【还剩" + hour + "小时】");
//					} else if (endDate == startDate) {
//						hour = TimeFormat.getHour(endtime)
//								- TimeFormat.getHour(starttime);
//						if (hour < 1) {
//							holder.borrow_lasttime.setText("到期");
//						} else if (hour >= 1) {
//							holder.borrow_lasttime
//									.setText("【还剩" + hour + "小时】");
//						}
//					} else {
//						holder.borrow_lasttime.setText("到期");
...
//					Intent intent2 = new Intent(BorrowedBookActivity.this,
...
//						OpenBookHelper.openEBook(BorrowedBookActivity.this,
//								eBook.getEbookId());
//					} else if (item.paused) {
//						MZLog.d("wangguodong", "xxxx4444444");
//						Toast.makeText(BorrowedBookActivity.this, "继续下载",
...
//								localBook.source);
//						localBook.start(BorrowedBookActivity.this);
...
//								PROGRESS_FAILED);
//						Toast.makeText(BorrowedBookActivity.this, "暂停下载",
//								Toast.LENGTH_SHORT).show();
...
//								LoginUser.getpin(), localBook.book_id,
//								localBook.source);
//						localBook.start(BorrowedBookActivity.this); // 下载失败重新开始下载
//					} else {
//						// 开始下载
...
//														localBook.source);
//										localBook
//												.start(BorrowedBookActivity.this);
//									} else {
//										localBook.source = LocalBook.SOURCE_BORROWED_BOOK;
...
//				.getUserBorrowEndTime());
//
//		DownloadTool.download((Activity) BorrowedBookActivity.this,
...
//
//		if (!NetWorkUtils.isNetworkConnected(BorrowedBookActivity.this)) {
//			Toast.makeText(BorrowedBookActivity.this,
...
//				true,
//				new MyAsyncHttpResponseHandler(BorrowedBookActivity.this) {
//
//					@Override
...
//								textView.setText("您的借阅列表暂无书籍，快去书城选购吧");
//								lackbook_button.setText("去书城");
//							}
//							currentPage++;
//
//							if (ebook.resultList != null
//									&& ebook.resultList.size() < perPageCount)
//								noMoreBook = true;
//							else {
//								noMoreBook = false;
//							}
