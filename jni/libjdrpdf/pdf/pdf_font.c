...
// --{
static fz_font *
JD_READER_GET_FONT (fz_context *ctx, char *fontname, int ros, int serif)
{
    fz_font * nsft_font = NULL;
    
    if (strcmp("EU-B1", fontname) == 0 ||
        strcmp("EU-BD", fontname) == 0 ||
        strcmp("EU-F5X", fontname) == 0 ||
        strcmp("EU-H4", fontname) == 0 ||
        strcmp("EU-SXT", fontname) == 0 ||
        strcmp("EU-B1X", fontname) == 0 ||
        strcmp("EU-BKB", fontname) == 0 ||
        strcmp("EU-F6", fontname) == 0 ||
        strcmp("EU-H4X", fontname) == 0 ||
        strcmp("EU-TT", fontname) == 0 ||
        strcmp("EU-B2", fontname) == 0 ||
        strcmp("EU-BKBX", fontname) == 0 ||
        strcmp("EU-F6X", fontname) == 0 ||
        strcmp("EU-H5", fontname) == 0 ||
        strcmp("EU-X1", fontname) == 0 ||
        strcmp("EU-B2X", fontname) == 0 ||
        strcmp("EU-BKH", fontname) == 0 ||
        strcmp("EU-F7", fontname) == 0 ||
        strcmp("EU-H5X", fontname) == 0 ||
        strcmp("EU-X1X", fontname) == 0 ||
        strcmp("EU-B3", fontname) == 0 ||
        strcmp("EU-BKHX", fontname) == 0 ||
        strcmp("EU-F7X", fontname) == 0 ||
        strcmp("EU-H6", fontname) == 0 ||
        strcmp("EU-XF1", fontname) == 0 ||
        strcmp("EU-B3X", fontname) == 0 ||
        strcmp("EU-BX", fontname) == 0 ||
        strcmp("EU-F8", fontname) == 0 ||
        strcmp("EU-H6X", fontname) == 0 ||
        strcmp("EU-XFX", fontname) == 0 ||
        strcmp("EU-B4", fontname) == 0 ||
        strcmp("EU-BZ", fontname) == 0 ||
        strcmp("EU-F9", fontname) == 0 ||
        strcmp("EU-H7", fontname) == 0 ||
        strcmp("EU-XFZ", fontname) == 0 ||
        strcmp("EU-B4X", fontname) == 0 ||
        strcmp("EU-DY", fontname) == 0 ||
        strcmp("EU-F9X", fontname) == 0 ||
        strcmp("EU-H7X", fontname) == 0 ||
        strcmp("EU-XT", fontname) == 0 ||
        strcmp("EU-B5", fontname) == 0 ||
        strcmp("EU-F1", fontname) == 0 ||
        strcmp("EU-FX", fontname) == 0 ||
        strcmp("EU-HD", fontname) == 0 ||
        strcmp("EU-XY", fontname) == 0 ||
        strcmp("EU-B5X", fontname) == 0 ||
        strcmp("EU-F1X", fontname) == 0 ||
        strcmp("EU-FZ", fontname) == 0 ||
        strcmp("EU-HT", fontname) == 0 ||
        strcmp("EU-YB", fontname) == 0 ||
        strcmp("EU-B6", fontname) == 0 ||
        strcmp("EU-F2", fontname) == 0 ||
        strcmp("EU-H1", fontname) == 0 ||
        strcmp("EU-HT1", fontname) == 0 ||
        strcmp("EU-YT1", fontname) == 0 ||
        strcmp("EU-B6X", fontname) == 0 ||
        strcmp("EU-F2X", fontname) == 0 ||
        strcmp("EU-H1X", fontname) == 0 ||
        strcmp("EU-HT2", fontname) == 0 ||
        strcmp("EU-YT2", fontname) == 0 ||
        strcmp("EU-B7", fontname) == 0 ||
        strcmp("EU-F3", fontname) == 0 ||
        strcmp("EU-H2", fontname) == 0 ||
        strcmp("EU-HX", fontname) == 0 || 
        strcmp("EU-B7X", fontname) == 0 || 
        strcmp("EU-F4", fontname) == 0 || 
        strcmp("EU-H2X", fontname) == 0 || 
        strcmp("EU-HZ", fontname) == 0 || 
        strcmp("EU-B8", fontname) == 0 || 
        strcmp("EU-F4X", fontname) == 0 || 
        strcmp("EU-H3", fontname) == 0 || 
        strcmp("EU-KY", fontname) == 0 || 
        strcmp("EU-B8X", fontname) == 0 || 
        strcmp("EU-F5", fontname) == 0 || 
        strcmp("EU-H3X", fontname) == 0 || 
        strcmp("EU-NBS", fontname) == 0)
    {
        char * nsft_name;
        struct stat nsft_stat;
        extern char * JD_READER_GET_PATH (void);
        extern int __android_log_print(int prio, const char *tag,  const char *fmt, ...);
        
        asprintf(&nsft_name, "%s%s.TTF", JD_READER_GET_PATH(), fontname);
        
        if (stat(nsft_name, &nsft_stat) == 0)
        {
            nsft_font = fz_new_font_from_file(ctx, fontname, nsft_name, 0, 0);
        }
    ...
    if (nsft_font == NULL)
    {
        ...
        nsft_font =  fz_new_font_from_memory(ctx, fontname, data, len, 0, 0);
    }
...
{
    {
        fontdesc->font = JD_READER_GET_FONT(ctx, fontname, ros, serif);
        fontdesc->font->ft_substitute = 1;
        return;
    }
